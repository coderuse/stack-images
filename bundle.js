...
/***/ function(module, exports) {
	...
	window.addEventListener('DOMContentLoaded', function () {
	    ...
	    var part1DisplacedAnimationBox = new BABYLON.Animation('part1_translation', 'position', 30, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
	    ...
	    var part1OriginalAnimationBox = new BABYLON.Animation('part1_translation', 'position', 30, BABYLON.Animation.ANIMATIONTYPE_VECTOR3, BABYLON.Animation.ANIMATIONLOOPMODE_CONSTANT);
	    // An array with all animation keys
	    ...
	    part1.actionManager.registerAction(new BABYLON.ExecuteCodeAction(BABYLON.ActionManager.OnPickTrigger, function () {
	        if (part1.position.equals(new BABYLON.Vector3(-8.9, -3, 0))) {
	            part1.animations.push(part1DisplacedAnimationBox);
	            scene.beginAnimation(part1, 0, 100, false, 1, function () {
	    ...
	    part1TextureTask.onSuccess = function (task) {
